    ...
    <?php if ( bp_single_pic_exist() && bp_single_pic_check_owner()):?>
            ...
            <p>&nbsp;</p>
                ...
                <?php if ( function_exists('bp_pic_wire_get_post_list') ) : ?>
					<?php bp_pic_wire_get_post_list( bp_single_pic_id(), "Picture Wire", 'There are no wire posts', true, false ) ?>
                <?php endif; ?>
                </div>
    <?php else: ?>
		...
		<div id="message" class="info">
			<p><?php bp_word_or_name( __( "Eigther picture doesn't exist for this user or not for public viewing!", 'buddypress' ), __( "Eigther picture doesn't exist for %s or not for public viewing!", 'buddypress' ) ) ?></p>
		</div>
