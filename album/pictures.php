...
<div id="content">
	<h2><?php bp_word_or_name( __( "My Pictures", 'buddypress' ), __( "%s's Pictures", 'buddypress' ) ) ?></h2>
	...
	<?php else: ?>
		...
		<div id="message" class="info">
			<p><?php bp_word_or_name( __( "Why don't you show community, what an amazing collection you have got!", 'buddypress' ), __( "%s hasn't uploaded any public picture yet.", 'buddypress' ) ) ?></p>
		</div>
