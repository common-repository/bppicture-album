...
function bp_album_add_js() {
	...
	if ( $bp->current_component == $bp->album->slug )
		wp_enqueue_script( 'bp-album-js', WP_PLUGIN_URL . 'bppicture-album/bp-album/js/general.js' );
}
...
function bp_album_add_structure_css() {
	...
	wp_enqueue_style( 'bp-album-structure', WP_PLUGIN_URL . '/bppicture-album/bp-album/css/album.css' );
        wp_print_styles();
}
add_action( 'wp_head', 'bp_album_add_structure_css' );
